...
@section('content')
    ...
    <form action="{{ route('register') }}" method="post">
        <div class="form-group">
            ...
            <input type="text" required maxlength="255" class="form-control" id="business_name" name="business_name" value="{{ old('business_name') }}" autocomplete="organization">
        </div>
        <div class="form-group">
            <label for="email">Email address</label>
            <input type="email" required maxlength="255" class="form-control" id="email" name="email" value="{{ old('email') }}">
        </div>
        <div class="form-group">
